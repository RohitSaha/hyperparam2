...
best = fmin(evaluate_model, space=space, algo=tpe.suggest, max_evals=70, trials = trials)

pickle.dump(trials, open("myfile_2.p", "wb"))
pickle.dump(best, open("best_2.p", "wb"))
